type LogoProps = {
  ...
  radius?: number;
  gradientId?: string;
  /** Uses --p-accent / --p-accent-ink from parent (export preview & styled exports). */
...
export function Logo({
  ...
  if (variant === "accent") {
    return (
      ...
      >
        <rect className="lbg" width="32" height="32" rx="9" />
        <g
          className="lfg"
          strokeWidth="2.6"
          strokeLinecap="round"
        ...
        <path className="lfg2" d="M13 12.5 L21 16 L13 19.5 Z" />
      </svg>
    );
  }
